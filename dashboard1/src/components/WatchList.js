...
const WatchList = () => {
  ...
  const price = watchlist.map((item) => item.price);
  ...
  return (
    <span className="actions">
      <span>
        ...
        <Tooltip title="Sell (S)" placement="top" arrow onTransitionComponent={Grow}>
          <button className="sell">Sell</button>
        </Tooltip>

        <Tooltip title="Analytics (A)" placement="top" arrow onTransitionComponent={Grow}>
          <button className="action"><BarChartOutlined className="icon" /></button>
        </Tooltip>

        <Tooltip title="More (M)" placement="top" arrow onTransitionComponent={Grow}>
